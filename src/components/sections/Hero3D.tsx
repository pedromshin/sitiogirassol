          ...
          >
            ...
            {listingConfig.whatsappNumber && (
              <a
                ...
                className="w-full sm:w-auto px-8 py-4 font-bold rounded-lg text-center transition-all duration-300 hover:opacity-90 shadow-lg bg-[#128C7E] text-white flex items-center justify-center gap-2"
              >
