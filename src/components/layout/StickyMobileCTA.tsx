...
export default function StickyMobileCTA() {
  ...
  const whatsappUrl = listingConfig.whatsappNumber
    ? `https://wa.me/${listingConfig.whatsappNumber}?text=${encodeURIComponent(
      "Olá! Tenho interesse em reservar o Sítio Girassol."
    )}`
    : null;
          ...
          <div className="flex-1 flex gap-2">
            {whatsappUrl && (
              <a
                ...
                className="flex-1 flex items-center justify-center gap-1.5 py-3 rounded-lg font-bold text-sm transition-all bg-[#128C7E] text-white"
              >
