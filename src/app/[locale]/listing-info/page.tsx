...
export default async function ListingInfoPage({ params }: PageProps) {
  ...
  return (
    <div className="listing-info-page" style={{ backgroundColor: "#141E19" }}>
      {/* Hero section */}
      <section className="relative overflow-hidden pt-24 md:pt-32 pb-16 md:pb-24">
        <div className="absolute inset-0 bg-gradient-to-b from-[#1A2620]/50 via-transparent to-transparent pointer-events-none" />
